...
import { $listeningCall, connectToCall, disconnectFromCall } from '../../model/listeningCall';
...
const CallsTable: React.FC = () => {
    const { calls, isLoading, error, totalCalls, page, perPage } = useUnit($callsTableState);
    ...
    const handleTableChange: TableProps<CallRecord>['onChange'] = (pagination, filters, sorter) => {
