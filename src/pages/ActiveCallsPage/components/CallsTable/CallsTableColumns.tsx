...
export const getColumns = ({
    ...
    return [
        ...
        },
        {
            ...
            ellipsis: true, // Добавляем эллипсис для длинного содержимого
            width: '40%', // Делаем этот столбец гибким, занимающим доступное пространство
        },
        {
            title: 'Действия',
            key: 'actions',
            width: 100,
            align: 'center',
            fixed: 'right', // Фиксируем столбец действий справа
            render: (_, record) => {
                const isCurrentlyListening = listeningCallId === record.id;
